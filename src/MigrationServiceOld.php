...
final class MigrationService implements MigrationServiceInterface
{
     ...
     *
     * Delegates to DatabaseMigrationRepository::ensureTable(), which
     * runs compileCreateMigrationTable() only when tableExists() is false.
     */
     ...
     *
     * Used by MigrateInstallCommand to distinguish "already installed"
     * from "just created" so it can show the right message.
     */
